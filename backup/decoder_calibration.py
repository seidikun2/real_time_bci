...
def run_calibration(cfg: AppConfig, markers_file: Optional[str] = None, signal_file: Optional[str] = None):
    ...
    print(f"[calib] Mapa de representação: {rep_result['map_png']}")
    print(f"[calib] Manifesto Unity      : {rep_result['manifest_json']}")
    print(
    ...
    paths = {
        ...
        "representation_map": rep_result["map_png"],
        "representation_manifest": rep_result["manifest_json"],
    }
    ...
    return {
        ...
        "representation_map_path": rep_result["map_png"],
        "representation_manifest_path": rep_result["manifest_json"],
        "meta": meta,
